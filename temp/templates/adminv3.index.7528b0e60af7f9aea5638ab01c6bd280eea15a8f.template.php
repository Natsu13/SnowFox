<div  class="row"><div  class="col-md-12"><div  class="mb-2"><span  class="oneline mr-2"  id="language-selector"><a  href="#"  class="button toggle"  data-lang="null"><?php echo t("Default"); ?></a>  <?php foreach($model["languages"] as $key => $lang) { ?><a  href="#"  class="button" <?php if((is_bool(  $lang ) && (  $lang )) || !is_bool(  $lang )) { echo " data-lang=\"" . ($lang) . "\""; } ?>><?php echo t($lang); ?></a>  <?php } ?></span> <a  href="#"  class="button disabled"  id="menu-new"><span  class="material-symbols-outlined">add</span>   <?php echo t("New item"); ?></a> </div> <div  class="card"  id="menu-selector"><div  class="pill-select"> <?php foreach($model["menus"] as $key => $menu) { ?><a  href="#" <?php if((is_bool(  $key ) && (  $key )) || !is_bool(  $key )) { echo " data-id=\"" . ($key) . "\""; } ?>><?php echo $key; ?></a>  <?php } ?></div> </div> <div  class="card no-card-margin-next"><div  class="flex"  id="menu-containers"><div><div  class="menu-box menu-box-static-text"  data-id="0"><div  class="text"><?php echo t("Drop menu from top to this box"); ?></div> </div> </div><div><div  class="menu-box menu-box-static-text"  data-id="1"><div  class="text"><?php echo t("Drop menu from top to this box"); ?></div> </div> </div></div> </div> </div> </div> <script> var notupdate = false;
    ...
    MenuManager.prototype.addItem = function(){
        ...
        manager.get("<?php echo Router::url(); ?>adminv3/menu/add/", {box: this.firstBoxId, language: language }, function (data) {
    ...
    MenuManager.prototype.loadMenu = function(selectedBox, box) {
        ...
        var language = $("#language-selector a.toggle").data("lang");
        var self = this;                
        manager.get("<?php echo Router::url(); ?>adminv3/menu/menu/"+box, {language: language }, function (data) {
    ...
    MenuManager.prototype.visibleItem = function(box, index) {
        ...
        manager.get("<?php echo Router::url(); ?>adminv3/menu/visibility_change/" + item_id, {}, function (data) {
    ...
    MenuManager.prototype.copyItem = function(box, index){
        ...
        manager.get("<?php echo Router::url(); ?>adminv3/menu/item_copy/" + item_id, {sort: sort }, function (data) {
            self.reloadMenus();
            manager.notification("<?php echo t('Saved'); ?>", "success");
        });
    };
    MenuManager.prototype.removeItem = function(box, index) {
        ...
        confirmBox("<?php echo t('Remove'); ?>", "<?php echo t('Are you sure you want to delete this item?'); ?>", function(){
            manager.get("<?php echo Router::url(); ?>adminv3/menu/item_remove/" + item_id, {}, function (data) {
                item.animate({opacity: 0 }, 300, function(){
                    $(this).remove();
                });
                manager.notification("<?php echo t('Removed'); ?>", "success");
            });
        }, function(){});
    };
    MenuManager.prototype.editItem = function(box, index){
        ...
        manager.get("<?php echo Router::url(); ?>adminv3/menu/edit/" + item_id, {}, function (data) {
